...
public class csGroupFinal {
	...
	//these links were used for "proof of concept" purposes and may not reflect real eligibility.
	...
	private static void eligibilityCalc(int adults, int totalAnnualIncome, int children) {//changed from public
		// adults = independents
		// children = dependents
	...
	private static void printAidInfo() { 
		if (aidAmount > 0) {
	...
	private static void eligibilityCalculator() { 
	...
	private static void nextSteps() {
		...
		eligibility = totalIncome / (dependents+independents);
	...
	private static void printLinks(String[] linksArray) { 
